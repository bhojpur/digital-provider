...
const (
	// Unknown means we don't know what state the Provider Engine is in
	EnginePhase_PHASE_UNKNOWN EnginePhase = 0
	// Preparing means the Provider Engine hasn't started yet and isn't consuming resources in the system
	EnginePhase_PHASE_PREPARING EnginePhase = 1
	// Starting means the Provider Engine has been scheduled and is waiting to run. Things that might prevent it
	// from running already are pod scheduling, image pull or container startup.
	EnginePhase_PHASE_STARTING EnginePhase = 2
	// Running means the Provider Provider Engine is actually running and doing work.
	EnginePhase_PHASE_RUNNING EnginePhase = 3
	// Done means the Provider Engine has run and is finished
	EnginePhase_PHASE_DONE EnginePhase = 4
	// Cleaning means the Provider Engine is in post-run cleanup
	EnginePhase_PHASE_CLEANUP EnginePhase = 5
	// Waiting means the Provider Engine is waiting for its start time or some other condition to be met
...
var file_provider_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x4c,
	...
	0x69, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x2d, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2f,
...
var file_provider_proto_depIdxs = []int32{
	...
	5,  // 27: v1.DigitalProvider.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.DigitalProvider.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.DigitalProvider.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.DigitalProvider.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.DigitalProvider.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.DigitalProvider.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.DigitalProvider.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.DigitalProvider.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.DigitalProvider.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.DigitalProvider.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.DigitalProvider.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.DigitalProvider.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.DigitalProvider.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.DigitalProvider.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.DigitalProvider.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.DigitalProvider.StopEngine:output_type -> v1.StopEngineResponse
...
func file_provider_proto_init() {
	...
	file_provider_proto_msgTypes[0].OneofWrappers = []interface{}{
